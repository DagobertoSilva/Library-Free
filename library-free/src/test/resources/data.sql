...
('Orgulho e Preconceito', '9788532523426', 'Jane Austen', 'Romance', 'Edição Clássica', '2009-01-01', 'Rocco', FALSE),
('O Guia do Mochileiro das Galáxias', '9788599296221', 'Douglas Adams', 'Ficção Científica', 'Edição do Filme', '2005-01-01', 'Sextante', FALSE),
('Fahrenheit 451', '9788525052300', 'Ray Bradbury', 'Distopia', 'Edição Padrão', '2012-05-21', 'Globo Livros', FALSE),
('Memórias Póstumas de Brás Cubas', '9788535910460', 'Machado de Assis', 'Realismo', 'Edição de Bolso', '2007-11-12', 'Companhia das Letras', FALSE),
